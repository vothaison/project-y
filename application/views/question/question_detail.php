...
<script>
    ...
    Data.SessionData = {
        ...
        PageData: {
            QuestionInfo:  <?= json_encode($data['info']) ?>
        },
        SiteUrl: "<?= site_url() ?>"
    };
</script>
...
<script type="application/javascript" src="<?= site_url("JavascriptBundle?app_name=".urlencode('question-detail')) ?>"></script>
<script type="application/javascript" src="<?= site_url("JavascriptBundle/templates?app_name=".urlencode('question-detail')) ?>"></script>
